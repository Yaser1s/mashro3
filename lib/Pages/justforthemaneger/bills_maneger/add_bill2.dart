...
import 'package:test10/Pages/justforthemaneger/bills_maneger/add_bill_damg.dart';
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        AddBill().addNewBil(
                          ...
                          conts: widget.conts,
                          price: widget.price,
                          allPrice: widget.conts *
                              widget.price, //widget.conts * widget.price,
                          numberCachMachen: "لايوجد",
                          cach: widget.conts *
                              widget.price, //widget.conts * widget.price,
                          context: context, numberDriver: widget.numberFarm,
                        );
